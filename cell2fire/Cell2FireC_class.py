...
class Cell2FireC:
    ...
    def run(self):
        ...
        execArray=[os.path.join(cell2fire_path,'Cell2FireC/Cell2Fire'), 
                   ...
                   '--out-sfc' if (self.args.OutSurfConsumption) else '',
                   ...
                   '--CBHPlan', self.args.CBHCells if(self.args.CBHCells is not None) else '',
    ...
    def run_Heur(self, OutFolder, HarvestPlanFile):
        ...
        execArray=[os.path.join(cell2fire_path,'Cell2FireC/Cell2Fire'), 
                   ...
                   '--CBHPlan', CBHPlanFile if(CBHPlanFile is not None) else '',
                   '--HFactor', str(self.args.HFactor),
                   '--FFactor', str(self.args.FFactor),
                   '--BFactor', str(self.args.BFactor),
                   '--EFactor', str(self.args.EFactor),
